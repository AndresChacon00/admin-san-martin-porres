...
export default function CreatePeriodoEvaluacionDesempeñoDialog({
  open,
  onClose,
}: {
  open: boolean;
  ...
  return (
    ...
    >
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Crear periodo de evaluación de desempeño</DialogTitle>
        </DialogHeader>
        <Form {...form}>
          <form
            className='space-y-4'
            onSubmit={form.handleSubmit((data) =>
              fetcher.submit(data, {
                method: 'post',
                action: '/periodos-evaluacion-desempeño/nuevo',
              }),
            )}
          >
            <FormField
